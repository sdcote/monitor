...
serviceName="CoyoteMonitor"                                  # service name
serviceNameLo="coyoteMonitor"                                # service name with the first letter in lowercase
serviceUser="monitor"                                        # OS user name for the service
serviceGroup="monitor"                                       # OS group name for the service
...
javaArgs="coyote.loader.BootStrap"                           # arguments for Java launcher
javaVMArgs="-server -Xms512M -Xmx2G -XX:+UseConcMarkSweepGC" # arguments for Java VM
javaCommandLine="$javaExe $javaVMArgs $javaArgs"             # command line to start the Java service application
javaCommandLineKeyword="loader.BootStrap"                    # a keyword that occurs on the commandline, used to detect an already running service process and to distinguish it from others
